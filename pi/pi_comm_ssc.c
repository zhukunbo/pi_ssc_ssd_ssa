...
#define DEFAULT_STATIC_CNT      0
#define DEFAULT_DYN_CNT         0
#define DEFAULT_AGE_TIMER       300
...
{   
    ...
    /* 默认老化时间300s */
    g_mac_local_db.age_time          = DEFAULT_AGE_TIMER; 
    g_mac_local_db.dyn_addr_count    = DEFAULT_STATIC_CNT;
    g_mac_local_db.static_addr_count = DEFAULT_DYN_CNT;
