...
/* 消息分类，第4字节的高两位表示 */
#define SSC_ROOKIE_MSG_MAC			(SS_MSGID_UNDEF_MAC | 0x00)		/* SSC发送的消息(0000) */
#define	SSD_ROOKIE_MSG_MAC			(SS_MSGID_UNDEF_MAC | 0x40)		/* SSD发送的消息(0100) */
#define SSA_ROOKIE_MSG_MAC      	(SS_MSGID_UNDEF_MAC | 0x80)   /* SSD-SO发送的消息(1000) */
...
typedef struct pi_mac_entry {/*mac和vlan作为关键字*/
